  ...
  <div class="physical-layer">
    ...
    <b-container fluid class="physical-layer">
      <b-row align-v="center" align-h="center" class="wire-buttons">
        <b-col></b-col>
        <b-col cols="1">
          <b-button v-on:click="update1" :variant="'primary'">{{ in1 }}</b-button>
        </b-col>
        <b-col cols="1">
          <b-button v-on:click="update2" :variant="'primary'">{{ in2 }}</b-button>
        </b-col>
        <b-col cols="1">
          <b-button v-on:click="update3" :variant="'primary'">{{ in3 }}</b-button>
        </b-col>
        <b-col cols="1">
          <b-button v-on:click="update4" :variant="'primary'">{{ in4 }}</b-button>
        </b-col>
        <b-col></b-col>
      </b-row>
    </b-container>
