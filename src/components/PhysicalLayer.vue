...
<template>
  <div id="physical">
    <div class="physical-layer">
        ...
        <b-container fluid class="col">
          <b-row align-v="center" align-h="center">
            <div v-for="light in lights" :key="light.id">
              <b-col cols="1">
                <p v-if="light.value">
                  <img :src="light_on" class="img">
                </p>
                <p v-else>
                  <img :src="light_off" class="img">
                </p>
              </b-col>
            </div>
          </b-row>
      ...
      <b-container fluid class="col">
        <b-row align-v="center" align-h="center" class="wire-buttons">
          ...
          <div v-for="button in buttons" :key="button.id">
            <b-col cols="1">
              <b-button v-on:click="update(button.button)" :variant="'primary'">{{ button.button }}</b-button>
            </b-col>
          </div>
          <b-col></b-col>
        </b-row>
      ...
      <!-- possible options -->
      <b-container fluid class="col">Possible button actions:
        <ul>
          <li>inverse</li>
          <li>XOR</li>
          <li>Max/Min</li>
  ...
  methods: {
    update: function(nrButton) {
      switch (nrButton) {
        ...
        case 2:
          if (
            (this.lights[0].value && !this.lights[1].value) ||
            (!this.lights[0].value && this.lights[1].value)
          )
            this.lights[2].value = true;
          else this.lights[2].value = false;
          break;
        case 3:
          this.lights[3].value = !Math.max(
            this.lights[0].value,
            this.lights[1].value,
            this.lights[2].value
          );
